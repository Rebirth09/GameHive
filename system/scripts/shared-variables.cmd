...
---------------------------------------
This Batch script is originally created for GameHive.
...
if not "%script_type%" == "builder" (
	...
	(echo GameHive_path=!root_path!)>> "%tmp_infos_file%"
	(echo GameHive_binaries_path=!root_path!)>> "%tmp_infos_file%"
	...
	(echo GameHive_path=!build_path!)>> "%tmp_infos_file%"
	(echo GameHive_binaries_path=!build_path!)>> "%tmp_infos_file%"
...
set installroot_url=https://www.GameHive.ovh
...
if not "%script_type%" == "builder" (
	...
	(echo GameHive_binaries_url=%installroot_url%/repo/tools)>> "%tmp_infos_file%"
